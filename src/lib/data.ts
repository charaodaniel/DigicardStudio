...
export const initialCardData: CardData = {
  ...
  links: [
    ...
    { id: '3', type: 'linkedin', label: 'LinkedIn', value: 'https://linkedin.com/in/ricardo-oliveira', icon: 'linked_camera' },
    { id: '4', type: 'instagram', label: 'Instagram', value: 'https://instagram.com/ricardo.oliveira', icon: 'alternate_email' },
  ],
