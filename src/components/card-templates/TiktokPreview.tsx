        ...
        <div className="bg-white font-display text-[#121117] min-h-full flex flex-col overflow-y-auto no-scrollbar">
            ...
            <div className="relative px-6 -mt-16 z-30 flex flex-col items-center">
                ...
                <div className="flex w-full gap-3 mt-6">
                    <button className="flex-1 text-white font-bold py-3 rounded-xl transition shadow-lg flex items-center justify-center gap-2" style={{backgroundColor: themeColor}}>
                ...
                <div className="w-full mt-8 space-y-3 pb-24">
                    {links.map(link => (
                        <a key={link.id} href="#" className="flex items-center p-4 rounded-xl bg-gray-50 border border-gray-200 hover:border-primary transition group">
                            <div className="flex-1 flex items-center gap-4">
                                ...
                                <div><p className="font-bold text-sm">{link.label}</p><p className="text-xs text-gray-500">{link.value}</p></div>
                            </div>
            ...
            {/* Bottom Nav Mockup */}
            <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md bg-white border-t px-4 py-3 flex justify-between items-center z-50 shrink-0">
