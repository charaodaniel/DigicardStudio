                    ...
                    <div className="px-4 pb-4">
                        ...
                        <div className="mt-4">
                            ...
                            <div className="grid grid-cols-1 gap-2">
                                {links.map(link => (
                                    <a key={link.id} className="flex items-center justify-between p-2.5 bg-[#2B2D31] hover:bg-white/5 rounded-lg border border-white/5 transition-colors group" href={formatHref(link.type, link.value)} target="_blank" rel="noopener noreferrer">
                        ...
                        <div className="mt-6 flex flex-col gap-2">
                            <a 
                                ...
                                className="w-full bg-[#5865F2] hover:bg-[#4752C4] text-white font-bold py-2.5 rounded transition-all shadow-lg active:scale-95 text-sm text-center" 
