...
export default function SpotifyPreview({ cardData }: { cardData: CardData }) {
    ...
    return (
        <div className="dark h-full">
            <div className="bg-background-dark text-white min-h-full font-display overflow-y-auto">
                <div className="max-w-md mx-auto min-h-full flex flex-col">
                    <header className="relative w-full aspect-square overflow-hidden shadow-2xl shrink-0">
                        ...
                        <img alt="Artist Profile" className="w-full h-full object-cover" src={cardData.avatarUrl} />
                            ...
                            <a className="flex items-center justify-between p-4 bg-white/5 hover:bg-white/10 border border-white/5 rounded-xl transition-all group" href="#">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-400">Ouça "Madrugada Eterna"</p>
                                    </div>
                                </div>
                ...
                <style jsx>{`
                    ...
                    .dark .text-spotify-green { color: #1DB954 }
                `}</style>
            </div>
        </div>
    )
