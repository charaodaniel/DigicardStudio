...
export default function LinkedinPreview({ cardData }: { cardData: CardData }) {
    ...
    return (
        <div className="bg-slate-50 dark:bg-background-dark min-h-full flex justify-center items-start overflow-y-auto no-scrollbar">
            {/* Main Card Container */}
            <div className="relative w-full max-w-md bg-white dark:bg-[#1a192e] shadow-2xl flex flex-col min-h-full">
                {/* Header Image / Cover */}
