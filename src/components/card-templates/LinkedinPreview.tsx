...
export default function LinkedinPreview({ cardData }: { cardData: CardData }) {
    ...
    return (
        <div className="bg-slate-50 dark:bg-background-dark h-full flex flex-col overflow-hidden">
            {/* Main Card Container */}
            <div className="relative w-full max-w-md mx-auto bg-white dark:bg-[#1a192e] shadow-2xl flex flex-col h-full overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto no-scrollbar">
                    ...
                    {/* Links Section */}
                    <div className="mt-8 px-6 space-y-3 pb-12">
                ...
                <div className="bg-white dark:bg-[#1a192e] border-t border-gray-100 dark:border-gray-800 px-4 py-3 flex justify-between items-center shrink-0 z-30 shadow-[0_-4px_12px_rgba(0,0,0,0.05)]">
